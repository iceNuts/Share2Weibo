...
@interface photopluginsettingsListController: PSListController {
}
@end

@implementation photopluginsettingsListController
- (id)specifiers {
	if(_specifiers == nil) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"photopluginsettings" target:self] retain];
	}
	return _specifiers;
}

-(void) getNoAssistiveTouch:(PSSpecifier*)spec{
	NSURL *url = [[NSURL alloc] initWithString: @"cydia://package/com.icenuts.snapshotter"];
